    ...
    \<div className="min-h-screen bg-[#f7f4ed] text-[#173d3a]">
              ...
              \<div className="relative">
                ...
                {menuOpen && (
                  \<div className="absolute right-0 top-14 w-72 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-2xl">
                    ...
                    \<a
                      href="[https://wa.me/919841624060](https://wa.me/919841624060)"
                      target="\_blank"
                    ...
                    \<a
                      href="[https://www.instagram.com/simonanandhraj/](https://www.instagram.com/simonanandhraj/)"
                      target="\_blank"
                      rel="noopener noreferrer"
                      onClick={closeMenu}
                      className="flex items-center gap-4 border-t border-gray-100 px-5 py-4 text-sm font-semibold hover\:bg-[#f7f4ed] transition"
      ...
      \<section className="relative min-h-[720px] overflow-hidden bg-[#0d4743] text-white">
        ...
        \<div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-32 md\:pt-40">
          \<div className="grid lg\:grid-cols-[1.05fr\_0.95fr] items-center gap-10">
            ...
            \<div className="relative flex justify-center lg\:justify-end">
              ...
              \<img
                ...
                className="relative z-10 max-h-[570px] w-full max-w-[520px] object-contain drop-shadow-[0\_25px\_35px\_rgba(0,0,0,0.35)]"
              />
      ...
      \<footer className="bg-[#082f2d] text-white">
        \<div className="mx-auto max-w-7xl px-6 py-12">
          ...
          \<div className="mt-10 border-t border-white/10 pt-6 text-center text-xs text-white/40">
            ...
            \<a
              href="[https://www.instagram.com/ragul\_arunan/](https://www.instagram.com/ragul_arunan/)"
              target="\_blank"
              rel="noopener noreferrer"
